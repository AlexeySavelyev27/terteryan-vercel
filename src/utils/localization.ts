...
export const translations: Record<'ru' | 'en', Translation> = {
  ru: {
    ...
    main: {
      subtitle1: "Армянский пианист, композитор и педагог, посвятивший более 40 лет обучению в Московском музыкальном колледже, где воспитал множество музыкантов.",
      subtitle2: "Его многогранный талант проявился в исполнительстве, сочинении и глубокой преданности искусству — от романтической классики до авторской музыки с восточным колоритом.",
  ...
  en: {
    ...
    main: {
      subtitle1: "Armenian pianist, composer and educator who devoted over 40 years to teaching at the Moscow Music College, where he trained numerous musicians.",
      subtitle2: "His multifaceted talent manifested in performance, composition and deep devotion to art — from romantic classics to original music with Eastern flavor.",
