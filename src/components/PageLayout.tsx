      ...
      <div className="h-screen transition-colors duration-300">
        ...
        <div
          ...
          style={{
            ...
            filter: "none", // Don't apply filter until we know the theme
            zIndex: 0,
          }}
        />
    ...
    <div className="h-screen overflow-hidden transition-colors duration-300">
      ...
      >
        <div
          ...
          style={{
            width: "6px",
            backgroundColor: (isDark ?? false) ? "rgba(255,255,255,0.4)" : "rgba(0,0,0,0.4)",
            borderRadius: "3px",
            minHeight: "20px",
            right: "1px",
          }}
            ...
            <div
              ...
              style={{
                ...
                mask: `linear-gradient(to bottom, 
                  ...
                  rgba(0,0,0,1) calc(100% - clamp(20px, 6vh, 40px)), 
                  transparent 100%)`,
